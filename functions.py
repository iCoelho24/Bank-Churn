...
def df_informations(df):
    ...
    text = f'O dataset tem {df.shape[0]} linhas e {df.shape[1]} colunas. Desses, temos:'
    ...
    display(df_info)
    display(Markdown("<H3 style='text-align:left;float:lfet;'>Tipo dos dados:"))
    display(df_dtype)


def cv_classi(Modelo, X, y, Resultado):
